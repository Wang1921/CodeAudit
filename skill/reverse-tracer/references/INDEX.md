...
业务逻辑类漏洞（IDOR / Privilege Escalation / Authentication Bypass / Workflow Bypass / Race Condition / Insufficient Anti-Automation / Open Redirect）由 logic-auditor 自顶向下审查，不经过污点追踪。
